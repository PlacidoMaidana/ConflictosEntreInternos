...
-- Tiempo de generación: 27-01-2021 a las 14:35:11
...
CREATE TABLE IF NOT EXISTS `audiencias` (
  ...
  PRIMARY KEY (`id`),
  KEY `audiencias_seccion_index` (`seccion`),
  KEY `audiencias_interno_index` (`interno`)
...
DROP TABLE IF EXISTS `conflictos_internos`;
CREATE TABLE IF NOT EXISTS `conflictos_internos` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `internos` (
  ...
  `lpu` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fotos` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(14, 'El negro', 'negro', 'Pab3', '232323', 'internos\\January2021\\6JkIsHLW4VlHkpWfYpHT.png', '2021-01-20 20:17:58', '2021-01-20 20:17:58'),
(15, 'Pepe', 'Pistola', 'Pab2', '9898989933', 'internos\\January2021\\dRlOElVOFlbp5qHSIHB0.png', '2021-01-27 17:18:46', '2021-01-27 17:18:46');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `users_seccion_index` (`seccion`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
