            ...
            <div class="modal-dialog"  style="min-width: 50%">
                <div class="modal-content">
                    ...
                    <div class="card" style="min-width: 50%">
                        ...
                        <table id="seleccionar_interno" class="table table-striped table-bordered dt-responsive wrap " style="width:100%">
                            <thead>
                          <tr>
                              <th>id</th>
                              <th>apellido</th>
...
<script>
    $(document).ready(function() {
        $('#seleccionar_interno').dataTable( {
             "serverSide": true,
             "ajax":"{{url('interno2')}}",                
             "columns":[
                     {data: 'id', width: '5%'},
                     {data: 'apellido', name: 'interno.apellido', width: '5%'},
                     {data: 'nombre', name: 'interno.fecha', width: '5%'},
                     {data: 'pabellon', name: 'interno.pabellon', width: '10%'},
                     {data: 'fotos', name: 'fotos', width: '20%'},
                     {data: 'seleccionar', name: 'seleccionar', width: '10%'},
