...
class VoyagerInternosController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    {   
        // dd('Llegue asta el controlador de internos');
        // GET THE SLUG, ex. 'posts', 'pages', etc.
        $slug ='internos';// $this->getSlug($request);
        ...
        if (strlen($dataType->model_name) != 0) {
          ...
          if ($dataType->scope && $dataType->scope != '' && method_exists($model, 'scope'.ucfirst($dataType->scope))) {
            ...
            // Si no es administrador filtrar solo por el usuario logeado
       ...
       // dd ("aca llegamos bien");
         return view('internos_elegir', compact(
            'actions',
            'dataType',            
            'dataTypeContent',
            'isModelTranslatable',
