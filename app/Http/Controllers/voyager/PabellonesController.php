...
class PabellonesController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $u = DB::table('unidades')
        ->where('id', $request["unidadAlojamiento"])
        ->first();

        $request["descripcion_completa"]=$u->nombre." - ".$request["descripcion"];
